...
UPower1::Manager::Manager(DBus::Connection &connection,
                          ...
                          std::function<void ()> resuming_hook,
                          std::function<void ()> sleeping_hook)
...
void UPower1::Manager::NotifySleep(const std::string& action)
{}

void UPower1::Manager::NotifyResume(const std::string& action)
{}
